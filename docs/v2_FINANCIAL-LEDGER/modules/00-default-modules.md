...
#### 5. 세무 준비 지원 (계획)
- 세금 신고를 직접 대신하지 않고, 수입·지출·급여·원천징수·증빙자료를 정리하는 보조 기능
- 예상 세금, 세금 적립 권장액, 신고자료 준비 상태를 표시
- 필요 시 세무사에게 기간별 자료를 공유할 수 있는 흐름 검토
- 상세 방향성: [세무 준비 지원 기능](04-tax-management.md)
